...
class files extends SQLpdo{
  ...
  public function __construct(){
    ...
    function saveFiles($nameFile=null, $nameOrigin=null, $DisplayName = null, $date=null, $nameFolder=null){
		$sql = "INSERT INTO `".PREFIX_DB."File` (Name, OriginName, DisplayName, Date, NameFold) VALUES (:nameFile, :OriginName, :DisplayName, :date, :nameFolder)";
		$execute =  array(
			":nameFile" => $nameFile,
